...
Additionally, we use a custom function provided by Tucker Davis Technologies called "TDTbin2mat" that you can find in [there repository] (https://github.com/tdtneuro/TDTMatlabSDK)
